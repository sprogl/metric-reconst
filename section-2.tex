...
\begin{equation}
\Phi^{0 \circ} = d^\circ = \sum_{\ell \emm} \int \intd{\omega} \frac{ - \sfrac{2}{3} i \omega (-1)^\emm}{\sws{2}{B^2_\ell} + 9 M^2 \omega^2} \left[ \sws{2}{B_\ell} \sws{1}{B_\ell} - 3iM \omega (1 + \frac{\sws{2}{B_{\ell}}}{\sws{1}{B_{\ell}}}) \right] \bar{\psi}^{5 \circ}_{0, \ell -\emm}(- \omega) \sws{-2}{Y_{\ell \emm}} (\theta, \varphi_\star) e^{-i \omega u}
\end{equation}
