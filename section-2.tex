...
\begin{multline}
\mathcal{L}_\zeta g_{ab} n^a n^b = \Re \bigg[ 4 \rho \bar{\rho} \bar{\tau}^\circ \tilde{\eth}' \tilde{\eth} \tilde{\eth} \xi^\circ_l - 4 \rho^2 \bar{\rho} \bar{\tau}^{\circ 2} \tilde{\eth} \tilde{\eth} \xi^\circ_l + 2 \rho^2 \Psi^\circ \tilde{\eth}' \tilde{\eth} \xi^\circ_l + 4 \rho^2 \bar{\rho} \Psi^\circ \bar{\tau}^\circ \tilde{\eth} \xi^\circ_l\\
...
\begin{multline}
\mathcal{L}_\zeta g_{ab} n^a m^b = \bar{\rho} \tilde{\eth}' \tilde{\eth} \tilde{\eth} \xi^\circ_l - 2 \rho \bar{\rho} \bar{\tau} \tilde{\eth} \tilde{\eth} \xi^\circ_l + \rho (\rho + \bar{\rho}) \Psi^\circ \tilde{\eth} \xi^\circ_l - \bar{\rho} \Omega^\circ \tilde{\eth}' \tilde{\eth}' \tilde{\eth} f^\circ + 2 \rho \bar{\tau}^\circ \tilde{\eth}' \tilde{\eth} f^\circ\\
+ \left(\frac{1}{\rho} + \frac{\bar{\rho}}{\rho} \Omega^\circ - \bar{\rho} \Omega^{\circ 2} \right) \tilde{\eth}' \tilde{\thorn}' f^\circ + 2 (\rho + \bar{\rho}) \Omega^\circ \bar{\tau}^\circ \tilde{\thorn}' f^\circ - 2 \bar{\rho} \tau^\circ \tilde{\eth}' \tilde{\eth}' f^\circ - \frac{\rho^2}{\bar{\rho}} \Psi^\circ \tilde{\eth}' f^\circ\\
...
\begin{equation}
\mathcal{L}_\zeta g_{ab} m^a m^b = - 2 \bar{\rho} \tilde{\eth} \tilde{\eth} \xi^\circ_l + 2 \tilde{\eth}' \tilde{\eth} f^\circ + 2 \Omega^\circ \tilde{\thorn}' f^\circ + 4 \bar{\rho} \tau^\circ \tilde{\eth}' f^\circ + 8 \rho^{\prime \circ} f^\circ
\end{equation}
